...
- :kbd:`alt-b`, :kbd:`alt-f` move the cursor one word left or right or accept the autosuggestion, or moves forward/backward in the directory history if the command line is empty..
